  ...
  const personalRecords = [
    {
      ...
      title: "최장 거리 러닝",
      distance: "10.06킬로미터",
      icon: "/data/image 36.png", // Corrected path for web access
    },
    {
      id: 2,
      date: "2025년 7월 17일",
